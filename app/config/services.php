...
$di->set('assets', function () {
    ...
    $assetsManager->collection("landing")->addJs("js/inspinia.js");
    $assetsManager->collection("landing")->addJs("js/pace.min.js");
    $assetsManager->collection("landing")->addJs("js/cbpAnimatedHeader.js");
