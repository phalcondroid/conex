            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                    ...
                    <div class="row" style="margin-top : 10px;">
                      ...
                      <div class="col-sm-6 col-md-4">
                        <div class="thumbnail">
                          <?php echo $this->tag->image(array('img/inovatio2.jpg', 'style' => 'widht : 400px; height : 350px')); ?>
                          <div class="caption">
                      ...
                      <div class="col-sm-6 col-md-4">
                        <div class="thumbnail">
                          <?php echo $this->tag->image(array('img/inovatio3.jpg', 'style' => 'widht : 400px; height : 350px')); ?>
                          <div class="caption">
                            <h3>Tostada pad</h3>
                            <p class="trunk">
                                Collaboration Lab ‘Juntos por el Agua’ es una iniciativa conjunta de la Red Local de Pacto
                ...
                <div role="tabpanel" class="tab-pane" id="vacancy">
                    ...
                    <div class="row" style="margin-top : 10px;">
                        <div class="col-md-12">
                            <a href="<?php echo $this->url->get('services/createVacancy'); ?>" class="btn btn-default pull-right">
