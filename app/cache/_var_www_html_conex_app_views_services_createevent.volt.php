                            ...
                            <div class="row">
                                <div class="col-xs-4 col-md-4">
                                    <a href="#" class="thumbnail">
                                        <?= $this->tag->image(['img/car1.jpg', 'style' => 'width : 180px; height : 160px;']) ?>
                                    </a>
                                </div>
                                <div class="col-xs-4 col-md-4">
                                    <a href="#" class="thumbnail">
                                        <?= $this->tag->image(['img/car2.jpg', 'style' => 'width : 180px; height : 160px;']) ?>
                                    </a>
                                </div>
                                <div class="col-xs-4 col-md-4">
                                    <a href="#" class="thumbnail">
                                        <?= $this->tag->image(['img/car3.jpg', 'style' => 'width : 180px; height : 160px;']) ?>
                                    </a>
                                </div>
                            </div>
                            <div class="row">
