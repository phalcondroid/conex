        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="page-scroll" href="#testimonials">Negocios</a></li>
                    <li><a class="page-scroll" href="#pricing">Vinculación</a></li>
        ...
        <div class="item active">
            <div class="container">
                ...
                <div class="carousel-image wow zoomIn">
                    <!--<img src="<?= $this->url->get('img/laptop.png') ?>" alt="" />-->
                </div>
            </div>
        ...
        <div class="item">
            <div class="container">
                <div class="carousel-caption blank">
                    <br>
                    <br>
                    <h1>Forjamos a los mejores</h1>
                    <p>Y también aquí conectamos a los grandes para que hagan cosas grandes.</p>
                </div>
            </div>
            <!-- Set background for slide in css -->
...
<section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn" style="text-align:center">
            <img src="<?= $this->url->get('img/center1.jpg') ?>" style="text-align:center; margin: 0 auto;" alt="dashboard" class="img-responsive">
        </div>
...
<?= $this->assets->outputCss('landing-css') ?>
<?= $this->assets->outputCss('font') ?>
<?= $this->assets->outputJs('landing') ?>
