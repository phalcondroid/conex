    ...
    <section  class="container features">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center  wow zoomIn" style="text-align:center">
                <img src="<?= $this->url->get('img/plantonic.jpg') ?>" style="text-align:center; margin: 0 auto;" alt="dashboard" class="img-responsive">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 wow fadeInLeft">
                    <div class="team-member">
                        <img src="<?= $this->url->get($item->logo) ?>" class="img-responsive img-circle img-small" alt="">
                        <h4>
                            <span class="navy">
                                <?= $item->name ?>
                            </span>
        ...
        <div class="container">
            ...
            <div class="row features-block">
                ...
                <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                    <img src="<?= $this->url->get('img/iphone.jpg') ?>" class="img-responsive" alt="dashboard">
                </div>
