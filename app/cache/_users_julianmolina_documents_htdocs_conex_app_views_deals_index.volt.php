                ...
                <div class="col-md-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background-color: #7F1347;">
                            ...
                            <?= $this->tag->image(['img/event.png', 'style' => 'float:right; margin-top : -35px; width : 32px']) ?>
                        </div>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title" style="background-color:#024241;">
                        ...
                        <?= $this->tag->image(['img/anuncio.png', 'style' => 'float:right; margin-top : -35px; width : 32px']) ?>
                    </div>
                    <div class="ibox-content">
                ...
                <div class="col-md-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background-color:#FFA913">
                            ...
                            <?= $this->tag->image(['img/service.png', 'style' => 'float:right; margin-top : -35px; width : 32px']) ?>
                        </div>
                        <div class="ibox-content">
