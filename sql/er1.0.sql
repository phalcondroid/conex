...
-- Schema conex
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `conex` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci ;
USE `conex` ;
...
CREATE TABLE IF NOT EXISTS `conex`.`student_type` (
  `id_student_type` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `conex`.`company_sector` (
  `id_company_sector` INT NOT NULL AUTO_INCREMENT,
